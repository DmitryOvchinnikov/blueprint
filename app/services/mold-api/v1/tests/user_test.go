...
import (
	...
	"github.com/dmitryovchinnikov/blueprint/business/web/v1/response"
...
func (ut *UserTests) postUser201(t *testing.T) usergrp.AppUser {
	...
	email, err := mail.ParseAddress("dmitry@gmail.com")
	if err != nil {
...
func (ut *UserTests) putUser200(t *testing.T, id string) {
	...
	if ru.Email != email.Address {
		t.Fatalf("Should not affect other fields like Email : got %q want %q", ru.Email, "dmitry@gmail.com")
	}
}
