...
import (
	...
	"github.com/dmitryovchinnikov/blueprint/app/services/mold-api/v1/cmd"
	"github.com/dmitryovchinnikov/blueprint/app/services/mold-api/v1/cmd/all"
	"github.com/dmitryovchinnikov/blueprint/app/services/mold-api/v1/cmd/crud"
	"github.com/dmitryovchinnikov/blueprint/app/services/mold-api/v1/cmd/reporting"
)

/*
	Need to figure out timeouts for http blueprint.
*/
